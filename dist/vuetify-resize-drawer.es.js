import { unref as d, defineComponent as $e, mergeDefaults as Le, inject as oe, ref as b, watchEffect as Me, toRefs as Ge, computed as p, useSlots as Ie, onBeforeMount as ze, onMounted as Pe, onUnmounted as xe, watch as He, openBlock as O, createBlock as ie, mergeProps as Ne, withCtx as Re, createElementBlock as re, normalizeClass as le, normalizeStyle as ue, renderSlot as T, createCommentVNode as V, defineAsyncComponent as Oe } from "vue";
 ...
 * @license MIT License
 */
const C = "v-resize-drawer", Ye = { handleBorderWidth: 8, handleColor: "primary", handleIcon: void 0, handleIconSize: "x-small", handlePosition: "center", height: 256, location: "start", maxHeight: window.innerHeight, maxWidth: window.innerWidth, minHeight: 56, minWidth: 56, modelValue: !0, name: void 0, rail: !1, railWidth: 8, resizable: !0, saveWidth: !0, snapBack: !0, storageName: `${C}-width`, storageType: "local", tag: "nav", theme: void 0, touchless: !1, width: 256 };
function X(u, r) {
...
const ce = (u, r) => {
  ...
  const Fe = p(() => ((a) => {
  ...
  })({ absolute: e.value.absolute, expandOnHover: e.value.expandOnHover, floating: e.value.floating, isMouseover: E, location: e.value.location, rail: e.value.rail, railWidth: e.value.railWidth, temporary: e.value.temporary })), pe = p(() => ((a) => {
  ...
  })({ isMouseDown: M, location: e.value.location, maxWidth: H.value, minWidth: x.value, rail: e.value.rail, railWidth: e.value.railWidth, resizedAmount: s.value, snapBack: e.value.snapBack || e.value.widthSnapBack })), ge = p(() => {
  ...
  })({ drawerLocation: e.value.location, handlePosition: e.value.handlePosition })), we = p(() => ((a) => {
    ...
    let L = `${o}px`, D = `${o}px`;
    return m === "border" ? (h === "bottom" || h === "top" ? L = S({ value: n }) : (L = "100%", D = S({ value: n })), { backgroundColor: ce(t, W), height: L, width: D }) : { backgroundColor: "transparent", height: L, transform: h === "top" || h === "bottom" ? $ : void 0, width: D };
  })({ borderWidth: e.value.handleBorderWidth || 1, handleColor: e.value.handleColor, iconSize: e.value.handleIconSize, iconSizeUnit: G.value, location: e.value.location, position: e.value.handlePosition, theme: U })), De = p(() => (!e.value.touchless || !me.mobile.value) && !(!e.value.resizable || e.value.rail) && !!K.value), K = p(() => e.value.location !== "bottom" && e.value.location !== "top" || e.value.handlePosition !== "bottom" && e.value.handlePosition !== "top"), Be = p(() => ((a) => {
    const { color: n, theme: t } = a;
    return { color: ce(n, t) };
  })({ color: i.handleColor, theme: U })), ye = p(() => ((a) => {
  ...
  })({ drawerLocation: e.value.location, handlePosition: e.value.handlePosition, iconOptions: B, isUserIcon: e.value.handleIcon != null && e.value.handleIcon !== "" })), Ce = p(() => ((n) => {
    ...
    return $;
  })({ icon: e.value.handleIcon, iconOptions: B, name: e.value.handlePosition })), G = b(se(String(c.value)));
  function Ae() {
  ...
  Object.keys(ve).some((a) => a.includes(String(c.value))) && (G.value = se(ve[String(c.value)]));
  const H = p(() => {
